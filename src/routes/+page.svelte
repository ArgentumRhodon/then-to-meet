<script lang="ts">
	...
	let inputLink = '';
	let selectLink = '-1'; // Value for "Load Previous"
...
<div class="h-full flex flex-col lg:flex-row">
	<div class="bg-surface-900 lg:w-96 min-w-96 h-min lg:h-full p-4 shadow-2xl">
		<div class="input-group sm:grid-cols-[auto_1fr_auto] lg:grid-cols-none">
			...
			/>
			<button class="btn variant-filled-primary p-4" on:click={() => loadLink(inputLink)}>
				Load Meeting
			</button>
		</div>
